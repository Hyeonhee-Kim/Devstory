...
FileApiController {
    ...
    // 파일을 업로드할 디렉터리 경로
    private final String uploadDir = Paths.get("/users/my/desktop", "tui-editor", "upload").toString();
    ...
    public String makeDir() {
        ...
        String path="/users/my/desktop/DevStory/src/main/resources/static/thumbnail"; //경로
...
//        System.out.println(savename);
    ...
    public String makeDir2() {
        ...
        String path="/users/my/desktop/DevStory/src/main/resources/static/profile"; //경로
